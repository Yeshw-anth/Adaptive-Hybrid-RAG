...
class IngestionPipeline:
    ...
    async def ingest_file_unstructured(self, file_path: str) -> List[TextNode]:
        ...
        try:
            nodes = await self.chunking_engine.chunk_document(file_path)
    ...
    def ingest_file_manual(self, file_path: str) -> List[TextNode]:
        """
        ...
        try:
            ...
            # The old loaders had a 'load_and_chunk' method.
